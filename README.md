...
- [v0.1.22](https://github.com/Yummn/sts2-turn-rewind/releases/tag/v0.1.22)：回溯现在会等待动作执行器、出牌队列、手牌拖拽队列和中央出牌节点连续四帧全部空闲后再恢复，专门修复回响形态重复出牌动画未完全释放时回溯，下一张牌卡在屏幕中央且不结算的问题。已为 PC v0.107.1、Android v0.103.2 和 Android v0.110.1 完成对应程序集编译。
